...
package com.android.wallpaper.livepickers;
...
import com.android.wallpaper.livepickers.utils.ReflectUtils;
...
public class LiveWallpaperPreview extends Activity {
    ...
    private void setLiveWallpaper(IBinder windowToken) {
        //因为是隐藏方法 移植出来在android Studio上没法直接Run 所以需要用反射
       // mWallpaperManager.setWallpaperComponent(mWallpaperIntent.getComponent());
        ReflectUtils.reflect(mWallpaperManager).method("setWallpaperComponent", mWallpaperIntent.getComponent());
